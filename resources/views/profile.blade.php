            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mb-4">
                        <img src="{{ Auth::user()->avatar ? asset(Auth::user()->avatar) : asset('sb-admin/img/undraw_profile.svg') }}" class="img-fluid rounded-circle" style="width: 150px; height: 150px;" alt="Profile Picture">
                    </div>
